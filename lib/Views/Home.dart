        ...
        : Scaffold(
            ...
            body: SingleChildScrollView(
              child: Column(children: <Widget>[
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: AssetImage('assets/images/cnsfinalnew.jpg'),
                        fit: BoxFit.fill,
                      ),
                      border: Border.all(
                ...
                //aphoto
                Text(
                  'Admiral Muhammad Amjad\nKhan Niazi NI(M) S Bt \nChief of the Naval Staff',
                ...
                new Container(
                  decoration:
                      new BoxDecoration(color: Colors.blueGrey.shade900),
                  child: new TabBar(
                    isScrollable: true,
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Expanded(
                                child: Flexible(
                                  child: Text(
                                    'Exercise AMAN-21 has been scheduled in North Arabian Sea in 1st quarter of 2021. Navies of different Countries have been invited to participate. This is the 7th exercise of AMAN series. AMAN is an Urdu word meaning “PEACE” and slogan of AMAN exercise is “Together for Peace”.',
                                    textAlign: TextAlign.justify,
                                  ),
                                ),
                              ),
...
//    ),
  ...
  void getdata() async {
    var response = await http.get(Uri.parse(Base_url + 'GalleryTypes'));
