...
import 'package:flutter_appnewoen/model/getlist.dart';
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount:
                                      getalldatalist[int].getlinklist.length,
    ...
    final ore = await SharedPreferences.getInstance().then((value) {
      if (value.getString('counter') != null) {
        ...
        if (getval == '0') {
          ...
          getalldatalist.add(getlist(
              'Exercise', 'assets/images/activities.jpeg', 'Activities', get1));
          getalldatalist
              .add(getlist('', 'assets/images/events.jpg', 'Events', get2));
          getalldatalist
          ...
          getalldatalist.add(getlist('Service & Support',
              'assets/images/service.jpg', 'Service & Support', get1));
        } else if (getval == "3") {
          List<getlink> get1 = [];
          ...
          get1.add(getlink('Greetings', '55'));

          getalldatalist
              .add(getlist('Misc', 'assets/images/misc.jpg', 'Misc', get1));
        }
        setState(() {
          getalldatalist;
        });
