...
class _ChatTwoPageState extends State<ChatTwoPage> {
                        ...
                        Expanded(
                          child: ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              if (reversedList[index].user1Email == getid)
                                return _buildMessageRow(
                                    reversedList[index].dialogId!,
                                    current: true);
                              return _buildMessageRow(
                                  reversedList[index].dialogId!,
                                  current: false);
  ...
  void getchats() async {
    ...
    var params = {"userid1": getid, "userid2": get};
    ...
    if (response.statusCode == 401) {
      ...
      for (var u in responseJson) {
        chatsdialogmodel post = chatsdialogmodel.a1(u['text'].toString(),
            u['senderId'].toString(), u['receiverId'].toString());
