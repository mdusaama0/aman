...
class _ShowListItemState extends State<ShowListItem>
  ...
  Future<void> getLatestData() async {
    ...
    Map<String, String> requestHeaders = {
      ...
      'Authorization': 'Basic ' + ore.get('counter').toString(),
    };
    ...
    if (response.statusCode == 401) {
      ...
      for (var u in responseJson) {
        chatsdialogmodel post = chatsdialogmodel.a1(u['fileName'].toString(),
            u['contentType'].toString(), '', u['path'].toString());
            ...
            body: getitemlist.length == 0
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Column(
                        children: [
                          (getitemlist[index].contentType.contains('image'))
                              ? Padding(
