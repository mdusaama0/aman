...
import 'package:flutter_appnewoen/Views/Gallery.dart';
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    Gallery(getgallerylist[index].dialogId!)),
                          );
                        },
                        child: ListTile(
  ...
  void getgallerypreview() async {
    ...
    if (ore.getString('counter') == null) {
      ...
      final response = await http.get(
        Uri.parse(Base_url + 'GalleryTypes'),
      ...
      if (response.statusCode == 401) {
        ...
        for (var u in responseJson) {
          chatsdialogmodel post =
              chatsdialogmodel.a1(u['id'].toString(), u['type'].toString(), '');
