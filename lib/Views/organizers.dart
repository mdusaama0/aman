...
import 'package:flutter_appnewoen/Views/speakers.dart';
...
//                 child: Image.asset('assets/images/background.jpeg',fit: BoxFit.cover),
  ...
  void check(int index) {
    if (index == 1) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => Leaders()));
    } else {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => speakers()));
    }
  }
    ...
    final ore = await SharedPreferences.getInstance().then((value) {
      if (value.getString('counter') != null) {
        ...
        getalldatalist.add(getlist(
            'Organizers', 'assets/images/organizer.jpg', 'Organizers', get1));
        setState(() {
          getalldatalist;
        });
      } else {
